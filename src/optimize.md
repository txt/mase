...
````python
   ...
   5:   from log  import *
````
<a href="optimize.py#L8-L12"><img src="http://www.craiggiven.com/textfile_icon.gif"></a>
...
````python
  ...
  24:     return wrapper
````
<a href="optimize.py#L88-L106"><img src="http://www.craiggiven.com/textfile_icon.gif"></a>
...
````
<a href="optimize.py#L158-L200"><img src="http://www.craiggiven.com/textfile_icon.gif"></a>
