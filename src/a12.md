...
````
<a href="a12.py#L13-L16"><img src="http://www.craiggiven.com/textfile_icon.gif"></a><br clear=all>
```python
...
````
<a href="a12.py#L234-L254"><img src="http://www.craiggiven.com/textfile_icon.gif"></a><br clear=all>
```python
...
````
<a href="a12.py#L262-L287"><img src="http://www.craiggiven.com/textfile_icon.gif"></a><br clear=all>
```python
