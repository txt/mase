...
<a href="dsl101.py#L304-L324"><img align=right src="http://www.hungarianreference.com/i/arrow_out.gif"></a><br clear=all>
```python
...
<a href="dsl101.py#L335-L353"><img align=right src="http://www.hungarianreference.com/i/arrow_out.gif"></a><br clear=all>
```python
...
<a href="dsl101.py#L359-L359"><img align=right src="http://www.hungarianreference.com/i/arrow_out.gif"></a><br clear=all>
```python
...
<a href="dsl101.py#L374-L402"><img align=right src="http://www.hungarianreference.com/i/arrow_out.gif"></a><br clear=all>
```python
...
<a href="dsl101.py#L486-L504"><img align=right src="http://www.hungarianreference.com/i/arrow_out.gif"></a><br clear=all>
```python
...
<a href="dsl101.py#L510-L521"><img align=right src="http://www.hungarianreference.com/i/arrow_out.gif"></a><br clear=all>
```python

  90:   class Diapers(Model):
  91:     def have(i):
  92:       return o(C = S(100), D = S(0),
  93:                q = F(0),  r = F(8), s = F(0))
  94:     def step(i,dt,t,u,v):
  95:       def saturday(x): return int(x) % 7 == 6
  96:       v.C +=  dt*(u.q - u.r)
  97:       v.D +=  dt*(u.r - u.s)
  98:       v.q  =  70  if saturday(t) else 0 
  99:       v.s  =  u.D if saturday(t) else 0
 100:       if t == 27: # special case (the day i forget)
 101:         v.s = 0
```

## Demo Code

<a href="dsl101.py#L527-L529"><img align=right src="http://www.hungarianreference.com/i/arrow_out.gif"></a><br clear=all>
```python

 102:   @ok
 103:   def _diapers1():
 104:     printm(Diapers().run())
```
...
<a href="dsl101.py#L623-L622"><img align=right src="http://www.hungarianreference.com/i/arrow_out.gif"></a><br clear=all>
```python
