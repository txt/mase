...
<a href="dsl101.py#L245-L252"><img align=right src="http://www.hungarianreference.com/i/arrow_out.gif"></a><br clear=all>
```python
...
<a href="dsl101.py#L265-L367"><img align=right src="http://www.hungarianreference.com/i/arrow_out.gif"></a><br clear=all>
```python
  ...
  71:   
  72:   
  73:   ### Support Utilities
  74:   
  75:   Here's a cool trick for printing lists of lists... but
  76:   only showing new values if they are different to the row above.
  77:   For example, with `printm`, our model outputs:
  78:   
  79:   ```
  80:   ###  _diapers1
  81:   t  | C   | D  | q  | r | s
 ...
 113:   ```
 114:   
 115:   Otherwise, the output is a little harder to read:
 116:   
 117:   ```
 118:   ##  _diapers1
 119:   t  | C   | D  | q  | r | s
...
def printm(matrix,less=True):
   ...
   for row in [fmt.format(*row) for row in s]:
      print(row)
<a href="dsl101.py#L389-L391"><img align=right src="http://www.hungarianreference.com/i/arrow_out.gif"></a><br clear=all>
```python
...
class Diapers(Model):
  ...
  def step(i,dt,t,u,v):
    ...
    if t == 27: # special case (the day i forget)
      v.s = 0
<a href="dsl101.py#L406-L408"><img align=right src="http://www.hungarianreference.com/i/arrow_out.gif"></a><br clear=all>
```python
