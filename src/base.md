...
````python
  ...
  70:       last = i
````
<a href="base.py#L118-L122">src</a>
...
````
<a href="base.py#L128-L132">src</a>
...
````python
  ...
  81:     random.seed(seed) 
````
<a href="base.py#L138-L143">src</a>
...
````
<a href="base.py#L159-L170">src</a>
...
````python
 ...
 114:     return ':%3.1f' % n
````
<a href="base.py#L176-L196">src</a>
...
````
<a href="base.py#L203-L205">src</a>
...
````
<a href="base.py#L211-L239">src</a>
...
````
<a href="base.py#L247-L251">src</a>
...
````
<a href="base.py#L257-L262">src</a>
...
````python
 ...
 161:   
````
<a href="base.py#L273-L276">src</a>
