...
````
<a href="base.py#L10-L12"><img src="http://www.craiggiven.com/textfile_icon.gif"></a>
## Misc Stuff
...
````
<a href="base.py#L19-L35"><img src="http://www.craiggiven.com/textfile_icon.gif"></a>
...
````
<a href="base.py#L49-L51"><img src="http://www.craiggiven.com/textfile_icon.gif"></a>
...
````python
  ...
  49:          )
````
<a href="base.py#L57-L82"><img src="http://www.craiggiven.com/textfile_icon.gif"></a>
...
````python
  ...
  65:         showd(d[k],lvl+1)
````
<a href="base.py#L88-L103"><img src="http://www.craiggiven.com/textfile_icon.gif"></a>
...
````python
  ...
  70:       last = i
````
<a href="base.py#L118-L122"><img src="http://www.craiggiven.com/textfile_icon.gif"></a>
...
````
<a href="base.py#L128-L132"><img src="http://www.craiggiven.com/textfile_icon.gif"></a>
...
````python
  ...
  81:     random.seed(seed) 
````
<a href="base.py#L138-L143"><img src="http://www.craiggiven.com/textfile_icon.gif"></a>
...
````
<a href="base.py#L159-L170"><img src="http://www.craiggiven.com/textfile_icon.gif"></a>
...
````python
 ...
 114:     return ':%3.1f' % n
````
<a href="base.py#L176-L196"><img src="http://www.craiggiven.com/textfile_icon.gif"></a>
...
````
<a href="base.py#L203-L205"><img src="http://www.craiggiven.com/textfile_icon.gif"></a>
...
````
<a href="base.py#L211-L239"><img src="http://www.craiggiven.com/textfile_icon.gif"></a>
...
````
<a href="base.py#L247-L251"><img src="http://www.craiggiven.com/textfile_icon.gif"></a>
...
````
<a href="base.py#L257-L262"><img src="http://www.craiggiven.com/textfile_icon.gif"></a>
...
````python
 ...
 161:   
````
<a href="base.py#L273-L276"><img src="http://www.craiggiven.com/textfile_icon.gif"></a>
