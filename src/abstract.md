...
````python
   ...
   7:       yield depth,x
````
<a href="abstract.py#L56-L62">src</a>
...
````
<a href="abstract.py#L114-L139">src</a>
...
````python
  ...
  55:   
````
<a href="abstract.py#L201-L222">src</a>
...
````
<a href="abstract.py#L245-L260">src</a>
...
````python
  ...
  88:     return wrapper
````
<a href="abstract.py#L271-L287">src</a>
...
````python
 ...
 104:       print("[",line,"]",sep="")
````
<a href="abstract.py#L297-L312">src</a>
...
````python
 ...
 121:   
````
<a href="abstract.py#L321-L337">src</a>
...
````
<a href="abstract.py#L346-L352">src</a>
...
````python
 ...
 133:       except: return x
````
<a href="abstract.py#L358-L362">src</a>
...
````python
 ...
 137:       print(cells)
````
<a href="abstract.py#L368-L371">src</a>
...
````python
 ...
 151:     return t
````
<a href="abstract.py#L383-L396">src</a>
...
````python
 ...
 163:    return tmp
````
<a href="abstract.py#L406-L417">src</a>
...
````
<a href="abstract.py#L423-L433">src</a>
