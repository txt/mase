...
_"Because engineering is optimization and optimization is search."_

MASE (rhymes with "base",  pronounced  "mace") presents concepts and code (in Python) relating to _research programming_; i.e. search-based exploration and optimization of models.

## What's new at MASE

Latest stuff listed first:
